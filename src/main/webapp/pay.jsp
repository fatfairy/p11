				...
				<div class="panel panel-default"  style="margin: 0 auto;width: 95%;">
				  <div class="panel-heading">
				    <h3 class="panel-title"><span class="glyphicon glyphicon-yen"></span>&nbsp;&nbsp;在线支付
				    	<span class="pull-right"><a href="getOrderList">返回订单列表</a>
				    	</span>
				    </h3>
				  </div>
				  <div class="panel-body">	 
					...
					<table class="table table-bordered table-striped table-hover">
						<tr>
							<td colspan="1">订单号:</td>
							<td colspan="3"><input type="text" class="form-control" name="WIDout_trade_no" value="<%=request.getParameter("oid")%>" readonly="readonly"></td>
						</tr>

						<tr>
							<td colspan="1">订单名称:</td>
							<td colspan="3"><input type="text" class="form-control" name="WIDsubject" value="xiaomi" readonly="readonly"></td>
						</tr>
						<tr>
							<td colspan="1">支付金额:</td>
							<td colspan="3">
								<div class="input-group" style="width: 200px;">
							      <input type="text" class="form-control"  name="WIDtotal_amount" value="<%=request.getParameter("omoney")%>">
